...
public partial class App : PrismApplication
{
    ...
    protected override void RegisterTypes(IContainerRegistry containerRegistry)
    {
        containerRegistry
            ...
            .RegisterSingleton<VocabularyService>()
            .RegisterSingleton<AnkiConnectService>()
            .RegisterSingleton<PlaybackControlsService>()
        ...
        containerRegistry.RegisterDialog<VocabularyDialog>();
    }
